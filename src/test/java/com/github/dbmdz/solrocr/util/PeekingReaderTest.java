...
import com.github.dbmdz.solrocr.formats.hocr.HocrParser;
...
class PeekingReaderTest {
  ...
  public void testEquivalence() throws IOException {
    ...
    PeekingReader peekingReader =
        new PeekingReader(new FileReader(sourcePath.toFile()), 2048, 16384);
  ...
  public void testBug() throws XMLStreamException {
    String fragment =
        "<span class='ocr_line' id='line_17_6' title=\"bbox 185 482 1492 539; baseline 0.003 -15; x_size 52; x_descenders 9; x_ascenders 13\">\n"
    ...
    Reader peekingReader =
        new PeekingReader(new SanitizingXmlFilter(new StringReader(fragment), false), 2048, 16384);
