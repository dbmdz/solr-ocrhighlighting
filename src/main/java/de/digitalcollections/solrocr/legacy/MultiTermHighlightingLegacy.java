 ...
 */
package de.digitalcollections.solrocr.legacy;
 ...
 *
 * Copied from Solr 8.3.1 for compatibility with versions < 8.4.
 *
 * @lucene.internal
 */
public final class MultiTermHighlightingLegacy {
  private MultiTermHighlightingLegacy() {
  }
   ...
   */
  public static CharacterRunAutomaton[] extractAutomata(
