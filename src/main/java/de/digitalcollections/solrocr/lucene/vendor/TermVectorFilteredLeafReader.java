 ...
 */
package de.digitalcollections.solrocr.lucene.vendor;
 ...
 * and be slow.
 *
 * NOTE: Completely copied from org.apache.lucene.search.uhighlight due to package-private access.
 *
 * @lucene.internal
 */
public final class TermVectorFilteredLeafReader extends FilterLeafReader {
   ...
   */
  public TermVectorFilteredLeafReader(LeafReader baseLeafReader, Terms filterTerms, String fieldFilter) {
